    ...
    def file_transfer(
        ...
        # PARALLEL VERSION: 
            ...
            while(first_segment<n) :
                ...
                t1 = threading.Thread(target=self.__send_data_parallel, args=(segments,vars,client_addr,number,window_size,n,))
                # THREAD FOR RECEIVING DATA
                t2 = threading.Thread(target=self.__receive_data_parallel, args=(number, vars,))
